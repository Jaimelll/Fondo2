...
$TABLAS = @(
  ...
  "avance_proyecto","avances","becas_nueva","condicion","documentos_gerenciales",
  "ejes","empresas","especialistas","etapas","finanzas_anual","formato","grupo",
  "informe_impacto","institucion","instituciones","instituciones_ejecutoras",
  "lineas","logs_actualizacion","metricas","modalidades","naturaleza_ie",
  "pagos_gestoras","presupuesto_anual_comparativo","presupuesto_mensual",
  "programa_proyecto","proyectos","regiones","saldo_bancario","sectores_ciiu",
  "tipo_estudio","unidades_operativas"
)
